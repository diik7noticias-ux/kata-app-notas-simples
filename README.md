...
- `notas_simples`      nome tecnico em snake_case (ex: lista_compras)
- `Notas Simples`   nome visivel (ex: Lista de Compras)
- `org.kata.notassimples`        package id (ex: org.kata.listacompras)
- `2026`          ano atual
